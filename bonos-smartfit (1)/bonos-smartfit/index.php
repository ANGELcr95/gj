...
<html lang="es">
    ...
    <header>
		...
		<div class="contenedor">
			...
			<form action="index.php" method="post" id="formulario" style="background:white; border-radius:10px; padding:50px 30px 40px 50px; text-align:center;">
				...
				<div class="formulario__grupo" id="grupo__condiciones">
						...
						<button  id="conditions">He leído y acpeto los términos y condiciones</button> 
						<i class="formulario__validacion-estado fas fa-times-circle"></i>
