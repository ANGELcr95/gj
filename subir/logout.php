...
$message =' <h3>'.$name.'</h3>
            ...
            <br>
            <span style="text-aling:center;font-size:24px;font-weight:bold;color:black;padding:30px;display:block;background-color:lightyellow;border:1px dashed brown;text-align:center">'.$codigoresp.'</span>
            <p>Puedes anotarlo y tomarle una foto, por seguridad también te lo enviamos a tu correo electrónico '.$correo.'</p>';
...
<html lang="es">
    ...
    <header>
            <div class="contenedor">
                        ...
                        <h2 style="color: white; font-weight: lighter;">¡Tu código de <b style="color: #fdb825;">SmartFit</b> ha sido enviado!</h3>
                    </div>
                ...
                <div id="modal_container4"  class="modal-container4 show4" style="height: auto;">
                    <div class="modal4">
                        ...
                        <?php endif; ?>
                        <div class="botones">
                            <button id="close5">+ Beneficios</button>
